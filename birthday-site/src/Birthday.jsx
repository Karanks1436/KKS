...
export default function BirthdayDad() {
  ...
  const PHOTOS = [
    ...
    "IMG-20241028-WA0005.jpg",
    "IMG-20250924-WA0010.jpg",
    "WhatsApp Image 2025-10-28 at 07.16.14 (1).jpeg",
    "WhatsApp Image 2025-10-28 at 07.16.14.jpeg",
    "WhatsApp Image 2025-10-28 at 07.16.46.jpeg",
    "WhatsApp Image 2025-10-28 at 07.18.09.jpeg",
  ];
  ...
  useEffect(() => {
    const q = query(collection(db, "birthdayWishes"), orderBy("timestamp", "desc"));
  ...
  return (
    <div className="birthday-dad-page">
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
      >
        <h3>💌 Send Your Birthday Wish to Dad</h3>
